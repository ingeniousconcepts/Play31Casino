...
/// Chip panel UI logic
/// </summary>
public class UIChipsPanel1 : MonoBehaviour {
    ...
    {
        int money = Game1.Instance.Money;
        int count = 0;
    ...
    void ChipClick(int id)
    {
        ...
        Chip1.Instance.ShowChips(this.chips[id].image, this.chips[id].transform.position);

        Game1.Instance.AddChips((int)Math.Pow(10, id));
